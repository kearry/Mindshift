...
export default function LLMSelector({
    ...
    return (
        ...
        <div className="text-sm font-medium mb-2" > Select LLM Provider </div>
            ...
            < div className = "flex space-x-2 mb-3" >
                <button
          className={
        `px-3 py-1 rounded text-sm ${provider === 'openai'
    ...
    < button
className = {`px-3 py-1 rounded text-sm ${provider === 'ollama'
    ...
    >
{
    ...
    {
        loadingModels?(
            <div className = "text-sm text-gray-500" > Loading Ollama models...</ div >
          ) : error ? (
    ...
    >
{
    ...
    <div className= "text-sm text-gray-500" > No Ollama models found.Please pull a model.</div>
          )}
<div className="mt-1 text-xs text-gray-500" >
    Requires Ollama running locally - <a href="https://ollama.ai" target = "_blank" rel = "noopener noreferrer" className = "text-blue-500 hover:underline" > https://ollama.ai</a>
</div>
    </>
      )}
</div>
